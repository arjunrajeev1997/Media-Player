...
function VideoCard({video,setDeleteVideoResponse,insideCategory}) {
  ...
  <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe className='w-100' height="395" src={`${video?.link}?autoplay=1`} title={video.caption} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        </Modal.Body>
      </Modal>
 </>
  )
